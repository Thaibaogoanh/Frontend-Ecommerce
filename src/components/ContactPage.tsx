      ...
      <div className="flex-1">
        ...
        <div className="bg-gradient-to-r from-[#BCF181] to-[#ca6946] text-black py-16">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h1 className="font-['Lora'] mb-4">Get In Touch</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <h2 className="font-['Lato'] uppercase tracking-wider mb-6">Contact Information</h2>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      123 Green Street, District 1<br />
            ...
            <div className="lg:col-span-2">
              <div className="bg-gray-50 rounded-xl p-8">
                <h2 className="font-['Lato'] uppercase tracking-wider mb-6">Send Us a Message</h2>
                ...
                <form className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#ca6946] hover:bg-[#b55835] text-white py-4 rounded-full transition-all flex items-center justify-center gap-2"
                  >
