      ...
      <div className="flex-1 flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="font-['Lora'] mb-2">Create Account</h1>
              ...
              <div className="space-y-3">
                <label className="flex items-start gap-2 cursor-pointer">
                  ...
                  <span className="text-sm">
                    I agree to the{' '}
                    <a href="#terms" className="text-[#ca6946] hover:underline">Terms of Service</a>
                    {' '}and{' '}
                    <a href="#privacy" className="text-[#ca6946] hover:underline">Privacy Policy</a>
                  </span>
                </label>
                ...
                <label className="flex items-start gap-2 cursor-pointer">
                  ...
                  <span className="text-sm">
                    Send me updates about sustainable products and special offers
                  </span>
                </label>
              </div>
          ...
          <div className="mt-6 bg-gradient-to-r from-[#BCF181] to-[#ca6946] rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="text-white">
                <p className="font-bold mb-1">Welcome Bonus!</p>
                <p className="text-sm text-white/90">
                  Get 100 Green Points when you sign up today 🎉
                </p>
              </div>
            </div>
          </div>
